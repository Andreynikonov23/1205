...
public class TableController {
   ...
   private Product product;
    ...
    @FXML
    private TableColumn<Product, Integer> warehouseColumn;
    ...
    void initialize(){
       ...
       CategoryColumn.setCellValueFactory(a -> new SimpleObjectProperty<>(a.getValue().getCategory_product().getId()));
        warehouseColumn.setCellValueFactory(a -> new SimpleObjectProperty<>(a.getValue().getWarehouse().getId()));
